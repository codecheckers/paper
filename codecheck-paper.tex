...
% count certificates: 
% curl https://raw.githubusercontent.com/codecheckers/register/master/register.csv | wc -l
% minus 1 for Hathway-Goodman (no empty last line, so no -1 for the headline needed)
