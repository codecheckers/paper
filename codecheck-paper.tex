...
\begin{table}
  ...
  \begin{tabular}{lllp{9cm}}  \toprule
    ...
    Paper from 1997 showing unsupervised learning from natural images \cite{Hancock1992-mp}.
    \\
    ...
    2020-012 & \cite{cert-2020-012} & Covid &  USA Covid modelling \cite{Unwin2020}. \\
    \\ \bottomrule
  \end{tabular}
